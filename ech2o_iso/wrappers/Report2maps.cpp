...
int Report2Maps(){
  ...
  if (oControl->Rep_Ponding)
    WriteMapSeries(oBasin->getPondingWater_before_infiltration(), "Ponding_", oControl->current_ts_count);
  ...
  if (oControl->Rep_SrftoChn){
    ...
    WriteMapSeries(oBasin->getChannelWater(), "ChnS", oControl->current_ts_count);
  }
  if (oControl->Rep_Infilt){
    WriteMapSeries(oBasin->getFluxInfilt(), "Inf", oControl->current_ts_count);
    WriteMapSeries(oBasin->getFluxInfiltR(), "InfR", oControl->current_ts_count);
  }
  if (oControl->Rep_Exfilt)
    //WriteMapSeries(oBasin->getFluxExfilt(), "RSrf", oControl->current_ts_count);
    WriteMapSeries(oBasin->getFluxL3toL2(), "Returnflow", oControl->current_ts_count);
...
int Report2Ts(){
  ...
  if (oControl->RepTs_Ponding){
    ...
    oReport->ReportTimeSeries(oBasin->getPondingWater_before_infiltration(),
